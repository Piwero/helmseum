...
{{- define "jellyfin.manifest.deployment" }}
...
spec:
  ...
  template:
    ...
    spec:
      ...
      {{- end }}
      {{- include "jellyfin.containers" (dict "deployment" $deployment) | nindent 6 }}
      {{- include "jellyfin.envFrom" (dict "configMap" $configMap "secrets" $secrets) | nindent 6 }}
